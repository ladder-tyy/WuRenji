...
void imuInit(void){
    ...
    {
        axo += accelEvent.acceleration.x;
        ayo += accelEvent.acceleration.y;
        azo += accelEvent.acceleration.z;
        gxo += gyroEvent.acceleration.x;
        gyo += gyroEvent.acceleration.y;
        gzo += gyroEvent.acceleration.z;
    }
